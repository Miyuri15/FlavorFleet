...
import { FaTrash, FaChevronLeft, FaChevronRight, FaArrowLeft } from 'react-icons/fa';
...
const CartPage = () => {
  ...
  const toggleItemCheck = (id) => {
    ...
    setSelectAll(cart.every(item => item._id === id ? !item.checked : item.checked));
  };
        ...
        {cart.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-2/3">
              ...
              {cart.map(item => (
                <div key={item._id} className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm mb-4 hover:shadow-md transition-shadow">
                  <input
                    type="checkbox"
                  ...
                  <div className="flex-grow">
                    <div className="flex justify-between">
                      <div>
                        <h3 className="text-lg font-semibold text-gray-800">{item.foodName}</h3>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <div className="flex items-center border border-gray-200 rounded-lg">
                        <button 
                          ...
                          className={`px-3 py-1 ${item.quantity <= 1 ? 'text-gray-300' : 'text-gray-600 hover:bg-gray-100'}`}
                        >
                          <FaChevronLeft />
                        </button>
